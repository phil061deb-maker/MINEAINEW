      ...
      <div className="w-full max-w-md">
        <div className="card p-7">
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <div className="mt-2 text-right">
                <Link className="text-xs text-zinc-400 hover:text-zinc-200" href="/auth/forgot">
                  Forgot password?
                </Link>
              </div>
            </div>
          ...
          <div className="mt-6 text-sm text-zinc-400">
            ...
            <Link className="text-amber-300 hover:text-amber-200" href="/auth/signup">
              Sign up
            </Link>
          </div>
        </div>
        ...
        <div className="mt-4 text-center text-xs text-zinc-500">
          ...
          and{" "}
          <Link className="hover:text-zinc-200" href="/legal/privacy">Privacy Policy</Link>.
        </div>
      </div>
    </div>
  );
